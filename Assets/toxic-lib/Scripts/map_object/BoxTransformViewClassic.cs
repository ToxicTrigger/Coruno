...
namespace Toxic
{
    ...
    public class BoxTransformViewClassic : MonoBehaviour
    {
        ...
        void Update()
        {
            if (this.m_PhotonView.IsMine)
            {
                ...
                {
                    m_PositionModel.onPlatform = false;
                }
                else
                {
                    m_PositionModel.onPlatform = this.transform.parent.GetComponent<MoveParent>() == null ? false : true;
                }
            }
        ...
        void UpdateRotation()
        {
            ...
            transform.GetChild(0).localRotation = this.m_RotationControl.GetRotation(transform.localRotation);
        }
